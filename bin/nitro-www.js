...
/////////////////////////////////////////////////////////////////////////////*/
  ...
  function WWWServer( options ){
    ...
    server.on( 'close', function(){
      console.error("nitro-www Shutting Down..");
    });
      ...
      if( argv.a && host !== '0.0.0.0' ){
        ...
        Object.keys(ifaces).forEach( function (dev){
          ifaces[dev].forEach( function (details){
            if(details.family === 'IPv4') logger.info(('  ' + protocol + details.address + ':' + port.toString()).green);
          });
        });
      }
    ...
    process.once( 'EADDRINUSE', function(){
      logger.info( "Required port unavailable".red);
      process.exit(1);
    });
